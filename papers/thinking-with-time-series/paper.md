...
**Contribution 5: Ablation and Analysis (消融与分析).** Through systematic ablation, we demonstrate that the trajectory generation step accounts for over 90% of the performance gain over text-only baselines, confirming that synthetic time-series genuinely serve as a reasoning medium rather than merely providing additional features.
